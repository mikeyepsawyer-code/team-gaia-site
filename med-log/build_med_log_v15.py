"""Medication Log v15 — per Michael's instruction (Aug 27 2026):
1) Shaded boxes lightened slightly (ECECEC -> F2F2F2).
2) New 6pm row: center three columns (Md, H, Pg) shaded and labeled
   "IVER-FEN" in light grey lettering, every day.
3) New midnight row: right-hand column (Av) shaded and labeled "R",
   every day.
Md/Pg dose-time shift from Aug 8 2026 (4am/noon/8pm and 4am/4pm)
carried forward unchanged. Base geometry replicated from approved v14
(fetched from GitHub)."""
...
c = canvas.Canvas("/mnt/user-data/outputs/Medication_Log_v15.pdf", pagesize=letter)
