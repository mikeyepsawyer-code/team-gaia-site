"""Medication Log v13 — adds Av (Advil) column after Pg, narrows existing
med columns 25%, lightens greys. All existing shaded times unchanged.
Base geometry replicated from approved v12 (fetched from GitHub)."""
...
c = canvas.Canvas("/mnt/user-data/outputs/Medication_Log_v13.pdf", pagesize=letter)
